...
--select * from products inner join stocks on products.id = stocks.product_id where id = '1f9fa292-0b77-4881-9fa4-b265b5dfa87d';
...
--cd2d45bd-509d-44a3-b899-2a8c216d4316
...
--delete from stocks where product_id = '15d4c64f-95c8-4ba6-a414-8c29d65e3861'
--delete from products where id = '15d4c64f-95c8-4ba6-a414-8c29d65e3861'
